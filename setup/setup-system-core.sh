...
# fix swap
	...
	print s 'vm.swappiness=10' | sudo tee /etc/sysctl.d/99-swappiness.conf
...
clonePackages() {
    ...
    print s "export VOIDNSRUN_DIR=/glibc" >>.zshrc
    print s "export VOIDNSUNDO_BIN=/usr/local/bin/voidnsundo" >>~/.zshrc
    print s "###############################################################################"
