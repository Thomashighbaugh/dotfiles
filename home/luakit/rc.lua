        ...
        elseif lfs.attributes(lf) then
            msg.warn(
                'Found local version ' ..
                    lf ..
                        " for core module '" ..
                            modname .. "', but it won't be used, unless you update 'package.path' accordingly."
            )
        end
    end
)
...
local newtab_chrome = require 'newtab_chrome'
newtab_chrome.new_tab_file = os.getenv('HOME') .. '/.config/luakit/newtab.html'

-- Put "userconf.lua" in your Luakit config dinewtab_chrome.new_tab_srcr with your own tweaks; if this is
