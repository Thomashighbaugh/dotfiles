...
settings.window.home_page = 'https://startpage-zwei.vercel.app/'
    ...
    function(view) --  during initialization of a new tab
        ...
        view:add_signal(
            ...
            function(v, uri, reason)
                ...
                elseif
                    low:match('%.webv') or low:match('%.gifv') or low:match('%.mp4') or low:match('%.avi') or
                        low:match('v%.redd%.it/') or
