...
function hardware(){
    while true; do
        cmd=(dialog --backtitle "Dotfiles Installer - Thomas Leon Highbaugh"  --title     "Hardware Specific" --clear --separate-output --checklist "Select Options:" 32 76 16 )
        options=(
            ...
            "Bluetooth" "- software for using bluetooth on Linux"
...
function TUI(){
    while true; do
        cmd=(dialog --backtitle "Dotfiles Installer - Thomas Leon Highbaugh"  --title     "Hardware Specific" --clear --separate-output --checklist "Select Options:" 32 76 16 )
        options=(
            "BASH"     "- for Ryzen Based Systems" off
            "Docker" "Interacting with an Android Phone" off
            "GPG" "- for E495 laptops" off
            "Git" "- for Nvidia GPUs" off
            "Grub"    "- Raspberry Pi 4 8GB" off
            "Hosts" "- Filesystem Management" off
...
function APPs(){
    while true; do
        ...
        options=(
            ...
            "Virt-Manager" "- open source virtualization source" off
            "Virtualbox" "- virtualization solution allowing easy management" off
