...
_Note: Since the current version provides '#'-rule as one of the default rules,
you can ignore this section._
...
Notice that the rule overrides `ignore_groups` attribute in order _not to ignore_
...
This new rule aligns text around spaces that are _not_ preceded by
